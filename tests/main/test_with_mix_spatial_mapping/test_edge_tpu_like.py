...
ens_lats = {
    "inputs/workload/alexnet.onnx": (6159980160, 8337351),
    "inputs/workload/mobilenetv2.onnx": (742114179, 2421959),
    "inputs/workload/resnet18.onnx": (1735517944, 4055269),
    "inputs/workload/resnet18.yaml": (2029477205, 4738407),
}
