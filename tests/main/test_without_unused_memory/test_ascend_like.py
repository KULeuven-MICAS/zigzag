...
ens_lats = {
    "inputs/workload/alexnet.onnx": (5649553476, 8605524),
    "inputs/workload/mobilenetv2.onnx": (1880536921, 6472147),
    "inputs/workload/resnet18.onnx": (1711355797, 3567658),
    "inputs/workload/resnet18.yaml": (2246606942, 4638794),
}
