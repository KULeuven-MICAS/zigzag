...
ens_lats = {
    "inputs/workload/alexnet.onnx": (6039993369, 8373281),
    "inputs/workload/mobilenetv2.onnx": (930699349, 1955657),
    "inputs/workload/resnet18.onnx": (1724869587, 3247768),
    "inputs/workload/resnet18.yaml": (2220200680, 3924484),
}
