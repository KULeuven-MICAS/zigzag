...
onnx_model_path = "lab5/resnet18_first_layer.onnx"

# List of accelerators architectures we run our experiment for
hardware = "lab5/accelerator.yaml"
# List of mappings for each accelerator
mapping = "lab5/mapping.yaml"

# Pickle filename to save list of cmes
pickle_filename = "lab5/outputs/list_of_cmes.pickle"
json_filename = "lab5/outputs/accelerator_layer_?.json"
