...
class AdderLevel:
    ...
    def __init__(self, index: int, name: str, details: dict[str, str | int]):
        """!  The class constructor
        ...
        self.unit = Adder(
            details["fan_in"],  # type: ignore
            details["unit_cost"],  # type: ignore
            details["unit_area"],  # type: ignore
            details["input_precision"],  # type: ignore
            details["output_precision"],  # type: ignore
        )
...
class AdderHierarchy:
    ...
    def __init__(
        self,
        adder_hierarchy: dict[str, dict[str, str | int]],
