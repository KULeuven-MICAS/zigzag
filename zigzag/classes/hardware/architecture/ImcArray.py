...
class ImcArray(OperationalArray):
    def __init__(
        self, tech_param: dict[str, float], hd_param: dict, dimensions: dict[str, int]
    ):
        ...
        self.tops_peak, self.topsw_peak, self.topsmm2_peak = (
            self.unit.get_macro_level_peak_performance()
        )
