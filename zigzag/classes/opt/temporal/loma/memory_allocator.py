...
from zigzag.classes.datatypes import Constants, LayerDim, LayerOperand, MemoryOperand, UnrollFactor, UnrollFactorInt
...
from zigzag.classes.workload.workload_attributes import LayerDimSizes, MemoryOperandLinks
