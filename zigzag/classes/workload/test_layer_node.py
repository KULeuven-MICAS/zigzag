...
class TestLayerNode(unittest.TestCase):
    def test_CONV2D_1(self):
        ...
        test_layer_node = LayerNode(
            test_equation,
            test_loop_dim_size,
            test_operand_precision,
            test_equation_relations,
        )

        result = test_layer_node.operand_loop_dim
        expect = {
            "O": {"r": ["G", "B", "K", "OY", "OX"], "ir": ["C", "FX", "FY"], "pr": {}},
            "W": {"r": ["G", "K", "C", "FY", "FX"], "ir": ["B", "OX", "OY"], "pr": {}},
            "I": {
                "r": ["G", "B", "C"],
                "ir": ["K"],
                "pr": {"IY": ["OY", "FY"], "IX": ["OX", "FX"]},
            },
        }
