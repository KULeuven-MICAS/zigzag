...
from zigzag.classes.datatypes import LayerOperand, PrLoop, UnrollFactor, LayerDim, UnrollFactorInt
from zigzag.classes.workload.workload_attributes import LayerDimSizes
...
def decouple_pr_loop(mapping_dict: SpatialMappingPerMEMLvl, layer_node: "LayerNode") -> SpatialMappingPerMEMLvl:
    ...
    # operand_loop_dim = {layer_op: layer_node.operand_loop_dim[layer_op] for layer_op in mapping_dict}
...
# ! Not used?
# def calc_data_size_MAC_count_per_loop(mapping_dict_reform: SpatialMappingPerMEMLvl, operand_loop_dim_reform: Dict):
