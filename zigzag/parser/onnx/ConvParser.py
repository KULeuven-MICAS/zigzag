...
class ConvParser(ONNXOperatorParser):
    ...
    def get_layer_node_input_format(
        ...
        data["loop_sizes"] = [batch_size, size_k, group_size, size_ox, size_oy, size_c, size_fx, size_fy]
    ...
    def generate_layer_node_for_conv(self):
        ...
        layer_data = self.get_layer_node_input_format(
            kernel_shape, strides, dilations, group_size, padding, ia_dimension_shape, oa_dimension_shape, prev_node_id
        )
