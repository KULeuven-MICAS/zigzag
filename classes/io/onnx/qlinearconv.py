...
class QLinearConvParser:
    """Parser for ONNX QLinearConv node into LayerNode.
    """
    ...
    def run(self):
        ...
        """
        layer_node = self.generate_layer_node_for_qlinearconv()
        return layer_node

    def generate_layer_node_for_qlinearconv(self):
        ...
        node_attrs = get_layer_node_input_format(kernel_shape, strides, dilations, 
                                                ...
                                                node_mapping, self.nodes_outputs)
