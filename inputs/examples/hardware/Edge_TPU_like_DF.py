...
def memory_hierarchy_dut(multiplier_array):
    ...
    sram_16K_with_16_1K_bank_128_1r_1w = \
        MemoryInstance(name="sram_16KB_A", size=1024 * 16 * 8, r_bw=128 * 16, w_bw=128 * 16, r_cost=1.7 * 16, w_cost=2.52 * 16, area=0,
                       r_port=1, w_port=1, rw_port=0, latency=1, min_r_granularity=64, min_w_granularity=64)

    sram_16KB_512_1r_1w = \
        MemoryInstance(name="sram_16KB_W", size=16384 * 8, r_bw=512, w_bw=512, r_cost=19.4, w_cost=33.9, area=0,
                       r_port=1, w_port=1, rw_port=0, latency=1, min_r_granularity=64, min_w_granularity=64)
    ...
    memory_hierarchy_graph.add_memory(memory_instance=sram_16KB_512_1r_1w, operands=('I2',),
                                      port_alloc=({'fh': 'w_port_1', 'tl': 'r_port_1', 'fl': None, 'th': None},),
                                      served_dimensions='all')
    memory_hierarchy_graph.add_memory(memory_instance=sram_1M_with_8_128K_bank_128_1r_1w_W, operands=('I2',),
                                      port_alloc=({'fh': 'w_port_1', 'tl': 'r_port_1', 'fl': None, 'th': None},),
                                      served_dimensions='all')
    memory_hierarchy_graph.add_memory(memory_instance=sram_16K_with_16_1K_bank_128_1r_1w, operands=('I1', 'O'),
                                      port_alloc=({'fh': 'w_port_1', 'tl': 'r_port_1', 'fl': None, 'th': None},
