...
def memory_hierarchy_dut(multiplier_array):
    ...
    reg_O4 = MemoryInstance(name="rf_4B", size=32, r_bw=16, w_bw=16, r_cost=0.022, w_cost=0.022, area=0,
                            r_port=2, w_port=2, rw_port=0, latency=1)

    ##################################### on-chip memory hierarchy building blocks #####################################

    sram_1KB_256_1r_1w_I = \
        MemoryInstance(name="sram_1KB_I", size=1024 * 8, r_bw=256, w_bw=256, r_cost=4.78, w_cost=5.59, area=0,
                       r_port=1, w_port=1, rw_port=0, latency=1, min_r_granularity=64, min_w_granularity=64)

    sram_1KB_256_1r_1w_W = \
        MemoryInstance(name="sram_1KB_W", size=1024 * 8, r_bw=256, w_bw=256, r_cost=4.78, w_cost=5.59, area=0,
                       r_port=1, w_port=1, rw_port=0, latency=1, min_r_granularity=64, min_w_granularity=64)

    sram_64KB_with_8_8KB_128_1r_1w_W = \
        MemoryInstance(name="sram_64KB_W", size=16384 * 8 * 8, r_bw=128 * 8, w_bw=128 * 8, r_cost=4.3 * 8, w_cost=7.07 * 8, area=0,
                       r_port=1, w_port=1, rw_port=0, latency=1, min_r_granularity=64, min_w_granularity=64)

    sram_64KB_with_8_8KB_128_1r_1w_A = \
        MemoryInstance(name="sram_64KB_A", size=16384 * 8 * 8, r_bw=128 * 8, w_bw=128 * 8, r_cost=4.3 * 8, w_cost=7.07 * 8, area=0,
                       r_port=1, w_port=1, rw_port=0, latency=1, min_r_granularity=64, min_w_granularity=64)
    ...
    sram_896K_with_7_128K_bank_128_1r_1w_A = \
        MemoryInstance(name="sram_896KB_A", size=131072 * 7 * 8, r_bw=128 * 7, w_bw=128 * 7, r_cost=26.01 * 7, w_cost=23.65 * 8, area=0,
                       r_port=1, w_port=1, rw_port=0, latency=1, min_r_granularity=64, min_w_granularity=64)
