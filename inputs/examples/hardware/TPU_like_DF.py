...
def memory_hierarchy_dut(multiplier_array):
    ...
    reg_W_64B = MemoryInstance(name="rf_64B", size=64 * 8, r_bw=8, w_bw=8, r_cost=0.053, w_cost=0.053, area=0,
    ...
    sram_64K_with_16_4K_bank_128_1r_1w = \
        MemoryInstance(name="sram_64KB_A", size=4096 * 16 * 8, r_bw=128 * 16, w_bw=128 * 16, r_cost=2.31 * 16, w_cost=5.93 * 16, area=0,
    ...
    '''
    memory_hierarchy_graph.add_memory(memory_instance=reg_W_64B, operands=('I2',),
    ...
    memory_hierarchy_graph.add_memory(memory_instance=sram_64K_with_16_4K_bank_128_1r_1w, operands=('I1', 'O'),
                                      port_alloc=({'fh': 'w_port_1', 'tl': 'r_port_1', 'fl': None, 'th': None},
